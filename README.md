...
![Status](https://img.shields.io/badge/Status-Live_&_Responsive-brightgreen?style=for-the-badge)

A highly interactive, modern web platform designed to showcase STEM education, robotics programs, and advanced DIY kits. Built from the ground up to deliver a **premium user experience**, this project demonstrates a strong command of modern front-end design principles, responsive layouts, and interactive micro-animations.
...
3. **Structured Curriculum Grid:** 
   * **Beginner Friendly:** "MakersGrid" foundational courses featuring interactive feature checklists.
   * **Advanced Robotics:** Detailed kit showcases (Drones, Bipedal robots, AI Vision arms) for older students.
4. **Achievement Timeline:** A visually engaging vertical timeline detailing milestones and awards.
5. **Interactive Gallery:** An image grid featuring grayscale-to-color hover reveals and scaling physics.
6. **Contact & Footer:** A polished off-canvas mobile navigation and modern footer design.
